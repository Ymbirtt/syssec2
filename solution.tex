...
%EtterCap and arp -a Screenshots here
\begin{figure}[h]
    \centering
...
In the attack, netwox %WHICH TOOL? 78, right?
...
A source quench packet %cite the RFC
is used when a host is receiving too much traffic, and requests that other hosts slow down their transmissions.

I was not able to make either of these attacks work on my network. Neither telnet, ftp, nor netcat reacted to being sent 
http://www.rfc-editor.org/rfc/rfc6633.txt
